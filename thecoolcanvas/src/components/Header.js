            ...
            <div className="hidden sm:flex absolute left-1/2 transform -translate-x-1/2 justify-center items-center w-full max-w-[500px] z-10 pointer-events-none">
              ...
              >
                ...
                {isSearchActive && searchQuery && (
                  <div className="absolute top-full left-0 right-0 mt-2 bg-white/50 backdrop-blur-sm border border-gray-200 rounded-xl shadow-2xl overflow-hidden z-50">
                  ...
                  <AnimatePresence>
                    {!isSearchActive ? (
                      ...
                      >
                        ...
                        {searchQuery && (
                          <div className="absolute top-full right-0 w-[240px] mt-4 bg-white/50 backdrop-blur-sm border border-gray-200 rounded-xl shadow-2xl overflow-hidden z-50">
